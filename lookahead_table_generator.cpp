...
LookaheadTableGenerator::LookaheadTableGenerator(Grammar * grammar, unsigned int ll_max_level, bool verbose_mode)
  : grammar(grammar), ll_max_level(ll_max_level), verbose_mode(verbose_mode) {};
...
vector<vector<string>> LookaheadTableGenerator::find_starting_tokens(string rule_name, unsigned int idx, int limit) {
